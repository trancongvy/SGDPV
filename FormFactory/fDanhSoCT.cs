    ...
    public partial class fDanhSoCT : XtraForm
    {
        ...
        private void simpleButton2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                MTID = MTID.Substring(0, MTID.Length - 1) + ")";
                ...
                foreach (DataRow drConfig in tbConfig.Rows)
                {
                    ...
                    foreach (DataRow drConfigDt in tbConfigdt.Rows)
                    {
                        ...
                        {
                            string sqlUpdate = "update " + blTableName + " set " + drConfigDt["blFieldName"].ToString() + " = a." + drConfigDt["mtFieldName"].ToString() + " from " + mtTableName + " a inner join " +
                                   blTableName + " b on b." + mtIDName  +"= a." + pk + " and NhomDK='" + nhomDk + "' and a." + pk  + MTID;
