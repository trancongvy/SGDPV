    ...
    public class SysMenu
    {
        ...
        public DataTable GetMenu()
        {
            ...
            else
            {
                ...
                string sql = "select t.*,r.*,m.*,ut.* , f.fData as Image1 from sysMenu m left join sysTable t on m.sysTableID = t.sysTableID left join sysReport r on  m.sysReportID = r.sysReportID " +
